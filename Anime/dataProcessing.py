...
class DataProcessor:
    ...
    def encode_data(self):
        ...
        try:
            ...
            raise CustomException("Failed to Encode users and anime",sys)
    ...
    def save_artifacts(self):
        ...
        try:
            ...
            logger.info(f"{name} saved successfully processed directory")
            ...
            logger.info("all the training and testing and rating_df is saved now")
        except Exception as e:
            raise CustomException("Failed to save processed artifacts",sys)
    ...
    def process_anime_data(self):
        ...
        try:
            ...
            raise CustomException("Failed to save DF and SYNOPSIS_DF",sys)
