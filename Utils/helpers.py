...
def find_similar_animes(name,path_anime_weights,path_anime2anime_encoded,path_anime2anime_decoded,
                        path_df,n=10,return_dist=False,neg=False):
    ...
    try:
        ...
        for close in closest:
            ...
            anime_frame = getAnimeFrame(int(decoded_id),path_df)
...
def get_user_reccomendation(similar_users, user_pref, path_df, path_rating_df, path_synopsis_df, n=10):
